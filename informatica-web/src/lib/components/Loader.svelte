...
{#if state.active}
	<div class="flex flex-col justify-center items-center">
		<div class="animate-bounce-slow">
			<div class="SevMini">
				...
				>
					...
					<path id="strobe-color1" d="M58 72.5L60.5 71V74L58 75.5V72.5Z" fill="#FF715E"></path>
					<path id="strobe-color2" d="M63 69.5L65.5 68V71L63 72.5V69.5Z" fill="#17e300b4"></path>
					...
					<path id="strobe-color3" d="M58 36.5L60.5 35V38L58 39.5V36.5Z" fill="#FF715E"></path>
		...
		<div class="transform -translate-y-6 -z-10 animate-ghost-pulse">
			<svg
				width="60"
				height="36"
				viewBox="0 0 60 36"
